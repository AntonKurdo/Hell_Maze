...
export default function({gender, level, viewport,  onChangeLevel, onChangeGender, onChangeViewPortSize}) {
    ...
    return (
        <div>      
            ...
            <select value = {(viewport+1).toString()} onChange={viewportChange} className="form-control">
